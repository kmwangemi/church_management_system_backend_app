...
Revision ID: c3ccd6b48ab8
Revises: 
Create Date: 2026-06-02 07:40:33.504839
...
def upgrade() -> None:
    ...
    sa.Column('phone_number', sa.String(length=255), nullable=True),
    sa.Column('global_role', sa.Enum('SUPER_ADMIN', 'ADMIN', 'USER', name='globalrole'), nullable=False),
    ...
    sa.Column('access_token_expires_at', sa.String(length=255), nullable=True),
    sa.Column('refresh_token_expires_at', sa.String(length=255), nullable=True),
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'MAINTENANCE', 'DISPOSED', name='assetstatus'), nullable=False),
    ...
    op.create_table('bishop_details',
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_bishop_details_id'), 'bishop_details', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_member_details_id'), 'member_details', ['id'], unique=False)
    op.create_table('offering',
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.Column('type', sa.Enum('TITHE', 'OFFERING', 'BUILDING_FUND', 'MISSIONS', 'OTHER', name='offeringtype'), nullable=False),
    sa.Column('payment_method', sa.Enum('CASH', 'M_PESA', 'BANK_TRANSFER', 'CARD', 'OTHER', name='paymentmethod'), nullable=False),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.Column('organization_id', sa.String(), nullable=False),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('organization_id', sa.String(), nullable=False),
    sa.Column('plan', sa.Enum('BASIC', 'MINISTRY', 'CATHEDRAL', 'CUSTOM', name='organizationplan'), nullable=False),
    ...
    op.create_index(op.f('ix_organization_subscription_id'), 'organization_subscription', ['id'], unique=False)
    op.create_table('pastor_details',
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_pastor_details_id'), 'pastor_details', ['id'], unique=False)
    op.create_table('pledge',
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('purpose', sa.String(length=255), nullable=True),
    sa.Column('status', sa.Enum('ACTIVE', 'COMPLETED', 'CANCELLED', 'OVERDUE', name='pledgestatus'), nullable=False),
    sa.Column('start_date', sa.DateTime(), nullable=False),
    ...
    op.create_table('prayer_request',
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('content', sa.String(), nullable=False),
    sa.Column('status', sa.Enum('ACTIVE', 'ANSWERED', 'CLOSED', name='prayerstatus'), nullable=False),
    sa.Column('user_id', sa.String(), nullable=True),
    sa.Column('organization_id', sa.String(), nullable=False),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_prayer_request_id'), 'prayer_request', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_visitor_details_id'), 'visitor_details', ['id'], unique=False)
    op.create_table('volunteer_details',
    sa.Column('user_id', sa.String(), nullable=False),
    ...
    op.create_index(op.f('ix_volunteer_details_id'), 'volunteer_details', ['id'], unique=False)
    ...
    op.create_table('availability_schedule',
    sa.Column('volunteer_details_id', sa.String(), nullable=False),
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['volunteer_details_id'], ['volunteer_details.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('volunteer_details_id')
    )
    op.create_index(op.f('ix_availability_schedule_id'), 'availability_schedule', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_background_check_id'), 'background_check', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_department_member_id'), 'department_member', ['id'], unique=False)
    ...
    op.create_table('pastor_assignment',
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['pastor_details_id'], ['pastor_details.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_pastor_assignment_id'), 'pastor_assignment', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_volunteer_role_id'), 'volunteer_role', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_availability_schedule_id'), table_name='availability_schedule')
    ...
    op.drop_index(op.f('ix_organization_subscription_id'), table_name='organization_subscription')
